    ...
    <SacredPortalLayout>
      <div className="space-y-1">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-[#174824]">Digital Archival & Media</h2>
            <p className="text-xs sm:text-sm text-[#5a4836] font-medium">
              Audio recordings, photo galleries, transcripts, and spiritual history
            </p>
          </div>
        </div>
      </div>
      ...
      <Card className="rounded-[24px] border-[#e5d9c3] bg-[#faf4e8] p-8 text-center space-y-3">
        ...
        <h3 className="text-lg font-bold text-[#174824]">Archival Module</h3>
        <p className="text-xs sm:text-sm text-[#5a4836] max-w-md mx-auto">
          Cloud storage integration for historical media, lectures, and memories.
        </p>
      </Card>
    </SacredPortalLayout>
  );
