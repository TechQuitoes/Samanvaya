    ...
    <SacredPortalLayout>
      <div className="space-y-1">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-[#174824]">Calendar & Schedules</h2>
            <p className="text-xs sm:text-sm text-[#5a4836] font-medium">
              Manage appointments, seva duties, and devotional programs
            </p>
          </div>
        </div>
      </div>
      ...
      <Card className="rounded-[24px] border-[#e5d9c3] bg-[#faf4e8] p-8 text-center space-y-3">
        ...
        <h3 className="text-lg font-bold text-[#174824]">Calendar Module</h3>
        <p className="text-xs sm:text-sm text-[#5a4836] max-w-md mx-auto">
          Schedule management and calendar syncing for spiritual leaders and sevaks.
        </p>
      </Card>
    </SacredPortalLayout>
  );
